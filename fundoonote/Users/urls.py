...
urlpatterns = [
    ...
    # url for Link
    url('Link/', views.LinkCreate.as_view(), name='home1'),
    url('list/', views.LinkList.as_view(), name='linklist'),
    path('Link/delete/<int:pk>/',views.LinkDelete.as_view(), name='delete_link')
